...
/** A system of registers whose frequencies make the octave obvious. */
...
describe('buildNoteKeyMap', () => {
  it('climbs one register per keyboard row', () => {
  ...
  it('fills a row that outruns its register from the next one up', () => {
  ...
  it('spills a register too long for one row onto the next row', () => {
  ...
  it('returns nothing when the starting register is out of range', () => {
